...
namespace AIOne
{
  ...
  public static class AIHelper
  {
    ...
    public static string GetBasicWords(string language)
    {
      ...
      switch (language.ToLower())
      {
        ...
        case "spanish": // see http://www.gutenberg.org/cache/epub/15353/pg15353.txt
          ...
          break;
        case "german":
          result = "alt,auch,bahnhofstraße,beruf,besonders,bin,bruder,computerspiele,denn,der,die,ein,eine,einen,eltern,englisch,er,erst,französisch,fußball,habe,haben,hallo,handy,handynummer,hobbys,ich,in,ist,jahre,königstraße,lehrer,mag,maier,mein,meine,möchte,mutter,nett,nicht,noch,schule,schüler,schwester,schwimmen,sehr,sie,sind,sport,studiert,tierärztin,und,vater,von,werden,wohne,zahnarzt,zahnärztin,zahnarztpraxis,zahnmedizin";
          break;
    ...
    {
      const AiEnumerations.ToneLevelFr UpToneLevelFr = AiEnumerations.ToneLevelFr.Action | AiEnumerations.ToneLevelFr.SereniteDeLEtre
      ...
      return toneLevel == UpToneLevelFr;
    }
    ...
    {
      const AiEnumerations.ToneLevelFr DownToneLevelFr = AiEnumerations.ToneLevelFr.Action | AiEnumerations.ToneLevelFr.SereniteDeLEtre
                                                 | AiEnumerations.ToneLevelFr.Postulats | AiEnumerations.ToneLevelFr.Jeux
                                                 | AiEnumerations.ToneLevelFr.Exultation | AiEnumerations.ToneLevelFr.Gaiete
                                                 | AiEnumerations.ToneLevelFr.Esthetique | AiEnumerations.ToneLevelFr.Enthousiasme
                                                 | AiEnumerations.ToneLevelFr.VifInteret | AiEnumerations.ToneLevelFr.Conservatisme
                                                 | AiEnumerations.ToneLevelFr.InteretModere | AiEnumerations.ToneLevelFr.Satisfait
                                                 | AiEnumerations.ToneLevelFr.Monotonie | AiEnumerations.ToneLevelFr.Ennui;
      return toneLevel != DownToneLevelFr;
    }

    public static bool IsDownTone(AiEnumerations.ToneLevelEn toneLevel)
    {
      const AiEnumerations.ToneLevelEn DownToneLevelEn = AiEnumerations.ToneLevelEn.Action | AiEnumerations.ToneLevelEn.SerenityOfBeingness
                                                         | AiEnumerations.ToneLevelEn.Postulates | AiEnumerations.ToneLevelEn.Games
                                                         | AiEnumerations.ToneLevelEn.Exhilaration | AiEnumerations.ToneLevelEn.Cheerfulness
                                                         | AiEnumerations.ToneLevelEn.Aesthetic | AiEnumerations.ToneLevelEn.Enthusiasm
                                                         | AiEnumerations.ToneLevelEn.StrongInterest | AiEnumerations.ToneLevelEn.Conservatism
                                                         | AiEnumerations.ToneLevelEn.MildInterest | AiEnumerations.ToneLevelEn.Contented
                                                         | AiEnumerations.ToneLevelEn.Monotony | AiEnumerations.ToneLevelEn.Boredom;
