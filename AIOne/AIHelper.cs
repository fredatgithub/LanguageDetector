    ...
    public static string GetBasicWords(string language)
    {
      ...
      switch (language)
      {
        ...
        case "spanish": // see http://www.gutenberg.org/cache/epub/15353/pg15353.txt
          result = "de,en,est,no,puedo,tu,eres,yo,contigo,mio,ir,la,playa,Señora,Presidenta,si,comprendo,bien,nuestra,colega,la,afirma,ella,que,este,tan,largo,texto,ha,sido,presentado,como,una,enmienda,oral";
          break;
        case "german":
          result = "ich";
          break;
